...
D6E Docker Runtimeの機能テストを5分で開始できます。

## ステップ1: Dockerイメージのビルド（1分）
...
## ステップ3: ワークスペースとテーブルの準備（1分）

1. ブラウザで http://localhost:3000 を開く
2. ユーザー登録/ログイン
3. ワークスペースを作成

MCPツールまたはフロントエンドで以下を実行：
...
## ステップ4: STFとポリシーの作成（2分）

以下のコマンドをMCPツール（Cursor AIなど）で実行：
...
すべてのテストが成功したら、Docker Runtime機能は正常に動作しています！🎉
